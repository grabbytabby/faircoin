...
extern void prompt4String(UniValue &out, const std::string &fieldName, const std::string &prompt, const std::string &defaultValue, const int nMaxLength, bool (*cbCheckValueStr)(string &strVal) = NULL);
...
extern bool ensureUpperCase(std::string &strVal);
