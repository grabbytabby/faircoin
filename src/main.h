...
/** Number of extended headers sent in one getheaders_s result. We rely on the assumption that
 *  if a peer sends less than this number, we reached its tip. Changing this value is a protocol
 *  upgrade. */
static const unsigned int MAX_SIGNED_HEADERS_RESULTS = 500; // max = 500 * 172 = 86kB
